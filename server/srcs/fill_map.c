...
{
	map[ADD_MINERAL(0, s->parse->height)][ADD_MINERAL(0, s->parse->width)]->food += (id == 0 ? 1 : 0);
	map[ADD_MINERAL(0, s->parse->height)][ADD_MINERAL(0, s->parse->width)]->linemate += (id == 1 ? 1 : 0);
	map[ADD_MINERAL(0, s->parse->height)][ADD_MINERAL(0, s->parse->width)]->deraumere += (id == 2 ? 1 : 0);
	map[ADD_MINERAL(0, s->parse->height)][ADD_MINERAL(0, s->parse->width)]->sibur += (id == 3 ? 1 : 0);
	map[ADD_MINERAL(0, s->parse->height)][ADD_MINERAL(0, s->parse->width)]->mendiane += (id == 4 ? 1 : 0);
	map[ADD_MINERAL(0, s->parse->height)][ADD_MINERAL(0, s->parse->width)]->phiras += (id == 5 ? 1 : 0);
	map[ADD_MINERAL(0, s->parse->height)][ADD_MINERAL(0, s->parse->width)]->thystam += (id == 6 ? 1 : 0);
}
